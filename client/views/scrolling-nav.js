...
if (Meteor.isClient) {
  ...
  Template.Nav.rendered = function () {
    ...
    //             // console.log("windowPos >= divPos: "+ (windowPos >= divPos));
    //             // console.log("windowPos < (divPos + divHeight): "+(windowPos < (divPos + divHeight)));
    //             if (windowPos >= divPos && windowPos < (divPos + divHeight)) {
    //                 $("a[href='" + theID + "']").parent().focus();
    //                 console.log("focused on "+ theID);
    //             } else {
    //                 $("a[href='" + theID + "']").parent().blur();
    //                 console.log("unfocused "+ theID);
    //             }
    //         }
